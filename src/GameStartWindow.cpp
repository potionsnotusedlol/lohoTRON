...
GameStartWindow::GameStartWindow(QWidget* parent) : QDialog(parent) {
    ...
    if (g_current_rounds_count < g_rounds_min || g_current_rounds_count > g_rounds_max) g_current_rounds_count = defs.rounds_default;
    ...
    connect(start_game_button, &QPushButton::clicked, this,
        [this, rounds_count, bots_count, bots_min, bots_max]() {
            ...
            if (auto* mw = qobject_cast<mainwindow*>(w)) mw->startGame(g_current_field_size, g_current_bots_count, g_current_rounds_count);
